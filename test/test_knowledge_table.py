...
class TestKnowledgeTable(TestCase):
    ...
    def test_set(self):
        self.knowledge_table.set_item(self.some_player, Cards.KNUPPEL, Knowledge.TRUE)
        self.assertEqual(
            self.knowledge_table.get_knowledge(self.some_player, Cards.KNUPPEL),
            Knowledge.TRUE
        )
    ...
    def test_invalid_overwrite_table(self):
        ...
        with self.assertRaises(ValueError):
            self.knowledge_table.set_item(self.some_player, Cards.KNUPPEL, Knowledge.FALSE)
    ...
    def test_get_current_player_hands(self):
        ...
        for player in self.game_state.players:
            knowledge_table.set_item(player, Cards.KNUPPEL, Knowledge.FALSE)

        knowledge_table.set_item(self.some_player, Cards.TOUW, Knowledge.TRUE)
